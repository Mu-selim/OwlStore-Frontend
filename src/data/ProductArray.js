...
export const ProductArray = [
  ...
  new Product(
    "AJAX AMSTERDAM OG TRACK JACKET",
    70,
    [
  ...
  new Product(
    "BASIC LOOSE FIT DENIM BERMUDA SHORTS",
    15,
    [
  ...
  new Product(
    "BASIC SHORT SLEEVE LINEN BLEND SHIRT",
    25,
    [
  ...
  new Product(
    "CITY ESCAPE AEROREADY WARMING TRACK TOP",
    60,
    [
  ...
  new Product(
    "SOFT-KNIT CARGO JOGGING TROUSERS",
    70,
    [
  ...
  new Product(
    "POLO SHIRT WITH MERCERISED FINISH",
    30,
    [
  ...
  new Product(
    "Boxy fit short sleeve print rhinestone T-shirt",
    25,
    [
