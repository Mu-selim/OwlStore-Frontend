...
import hero01 from "/images/hero02.png";
import hero02 from "/images/hero03.png";
import hero03 from "/images/hero04.png";
import hero04 from "/images/hero05.png";
      ...
      >
        <div className="hidden md:block md:basis-1/2 text-secondary">
          ...
          <p className="text-xl">
            ...
            placeat cum totam asperiores quae dolorum
          </p>
          <div className="mt-8">
            <Link
              to="/explore"
