...
export const Address = ({changeStage})=>{
    ...
    const nextStage= ()=>{
        ...
        if(address.city === "" || address.street === "" || address.building === "" || address.apartment === ""){
            setAddress({
                ...address,
                error:false
            })
        ...
        if (address.cityError !=="" || address.streetError !=="" || address.buildingError !=="" || address.apartmentError !==""){
            setAddress({
                ...address,
                error:false
            })
        ...
        <>
            <div className="address px-7 lg:flex lg:flex-col lg:items-center">
                ...
                <div className="flex justify-center mt-5 px-7">
                            <span className={address.error ? "hidden":"text-sm text-red-700 ml-1 font-bold"}>
                                Not valid inputs
                            </span>
                </div>
