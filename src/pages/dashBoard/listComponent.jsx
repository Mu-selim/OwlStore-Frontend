...
export let ItemsList = (props) => {
  ...
  itemsArrRef.filter((item) => {
    if (!uniquebrands.includes(item.brand)) uniquebrands.push(item.brand);
  });
  ...
  let EditFun = (i, item) => {
    ...
    gender.forEach((e) => {
      if (e.value == ShownArr[i].gender.toLowerCase()) e.checked = true;
    });
    ...
    <div>
        ...
        <form>
          <div className="relative ">
            ...
            <input
              ...
              type="text"
              id="search"
              className="w-full py-2.5 pl-7 text-sm border-3  rounded-xl"
      ...
      <div className="w-full flex flex-col mb-2 justify-between mt-1 md:flex-row">
        ...
        <div className="p-2 md:w-1/4">
          <button
            id="clearfilters"
            className="font-bold w-full  py-2 self-center rounded-lg"
              ...
              return (
                <tr className="bg-white hover:bg-gray-100" key={i}>
                  <td className="p-3 text-sm text-gray-700 whitespace-nowrap">
                    <span
                      className="font-bold text-blue-500 hover:underline cursor-pointer text-sm"
                  ...
                  <td className="p-3 text-sm text-gray-700 whitespace-nowrap flex flex-wrap w-28">
                    {item.colors.map((item, j) => {
                      return (
                        <div
                          className="mx-px mt-2.5"
                          key={j}
                          style={{
                            borderRadius: "100%",
                  ...
                  <td>
                    <div className="flex">
                      <button
                        className="bg-blue-500 hover:bg-blue-700 text-white font-bold  w-1/2 p-1.5 flex justify-center rounded-xl"
